...
class Blockchain(object):
    ...
    def resolve_conflicts(self):
        ...
        by replacing a chain in the node with the longest one in the network.
        :return: <bool> True if our chain was replaced, False if not
        """
        # Get all the nodes in the blockchain
        ...
        for node in neighbours:
            # Get the chain from the neighbour
        ...
        # Replace node's chain if a newly discovered valid chain longer
        if new_chain:
            self.chain = new_chain
            return True

        # Return False to indicate that there was no conflicts
        return False
